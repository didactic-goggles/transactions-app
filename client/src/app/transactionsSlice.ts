  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(fetchTransactions.rejected, (state, action) => {
        state.status = "failed"
        state.errors.fetchError = (action.error as Error).message
      })
      .addCase(addTransaction.fulfilled, (state, action) => {
        state.transactions.push(action.payload.transaction as ITransaction)
      })
      .addCase(addTransaction.rejected, (state, action) => {
        state.errors.addError = (action.error as Error).message
      })
      ...
      .addCase(editTransaction.rejected, (state, action) => {
        state.errors.editError = (action.error as Error).message
      })
